...
public class RegisterActivity extends AppCompatActivity {
    ...
    public boolean validate() {
        ...
        if (UserName.isEmpty()) {
            valid = false;
            Toast.makeText(this, this.getString(R.string.validate_user), Toast.LENGTH_SHORT).show();
        } else {
            if (UserName.length() > 5) {
                valid = true;
            } else {
                valid = false;
                Toast.makeText(this, this.getString(R.string.username_short), Toast.LENGTH_SHORT).show();
            }
        }
